...
page_id_name_mapping = sc.broadcast(page_data_df_fin.set_index("page_title"))
...
# page_data_df = page_data.toPandas().set_index("page_title")
...
# page_id_name_mapping = sc.broadcast(page_data_df)
